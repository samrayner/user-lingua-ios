...
extension AnyCasePath where Value == Never {
    ...
    @available(*, deprecated) public static var never: Self {
...
extension AnyCasePath where Value: RawRepresentable, Root == Value.RawValue {
    ...
    @available(*, deprecated) public static var rawValue: Self {
        .init(
            embed: { $0.rawValue },
...
extension AnyCasePath where Value: LosslessStringConvertible, Root == String {
    ...
    @available(*, deprecated) public static var description: Self {
        .init(
            embed: { $0.description },
            extract: Value.init
        )
