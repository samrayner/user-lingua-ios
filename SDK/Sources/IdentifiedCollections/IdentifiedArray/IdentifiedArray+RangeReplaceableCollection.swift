...
extension IdentifiedArray: RangeReplaceableCollection
    ...
    public mutating func replaceSubrange(_ subrange: Range<Int>, with newElements: some Collection<Element>) {
        ...
        _dictionary.reserveCapacity(count + newElements.count)
        for element in newElements.reversed() {
            _dictionary.updateValue(
                element,
                forKey: _id(element),
...
extension IdentifiedArray {
    ...
    public mutating func remove(at index: Int) -> Element {
        _dictionary.remove(at: index).value
    }
    ...
    public mutating func removeAll(
        ...
        try _dictionary.removeAll(where: { try shouldBeRemoved($0.value) })
    }
    ...
    public mutating func removeSubrange(_ bounds: Range<Int>) {
        _dictionary.removeSubrange(bounds)
    }
    ...
    public mutating func reserveCapacity(_ minimumCapacity: Int) {
        _dictionary.reserveCapacity(minimumCapacity)
    }
}
