...
extension CLAccuracyAuthorization: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CLAccuracyAuthorization.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
...
extension CLActivityType: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CLActivityType.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension CLAuthorizationStatus: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CLAuthorizationStatus.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension CLDeviceOrientation: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CLDeviceOrientation.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension CLProximity: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CLProximity.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
