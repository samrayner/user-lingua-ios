...
extension UIGestureRecognizer.State: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "UIGestureRecognizer.State.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension UIScrollView.ContentInsetAdjustmentBehavior: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return
                "UIScrollView.ContentInsetAdjustmentBehavior.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension UIUserInterfaceStyle: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "UIUserInterfaceStyle.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
    ...
    public var customDumpMirror: Mirror {
        struct Option: CustomDumpStringConvertible {
            ...
            var customDumpDescription: String {
                ...
                default:
                    "UIControl.State(rawValue: \(rawValue))"
                }
            }
        }
