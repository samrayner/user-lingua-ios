...
extension CIQRCodeDescriptor.ErrorCorrectionLevel: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return
                "CIQRCodeDescriptor.ErrorCorrectionLevel.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension CIDataMatrixCodeDescriptor.ECCVersion: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return
                "CIDataMatrixCodeDescriptor.ECCVersion.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension CIRenderDestinationAlphaMode: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CIRenderDestinationAlphaMode.(@unknown default, rawValue: \(rawValue)"
        }
    }
}
