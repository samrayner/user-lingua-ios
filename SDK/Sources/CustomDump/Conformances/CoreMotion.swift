...
extension CMAuthorizationStatus: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CMAuthorizationStatus.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension CMDeviceMotion.SensorLocation: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CMDeviceMotion.SensorLocation.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
...
extension CMFallDetectionEvent.UserResolution: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return
                "CMFallDetectionEvent.UserResolution.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
...
extension CMMotionActivityConfidence: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CMMotionActivityConfidence.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension CMPedometerEventType: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "CMPedometerEventType.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
