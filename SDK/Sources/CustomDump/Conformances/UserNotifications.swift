...
extension UNAlertStyle: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "UNAlertStyle.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension UNAuthorizationStatus: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "UNAuthorizationStatus.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension UNNotificationInterruptionLevel: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "UNNotificationInterruptionLevel.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
    ...
    public var customDumpMirror: Mirror {
        struct Option: CustomDumpStringConvertible {
            ...
            var customDumpDescription: String {
                ...
                if #available(iOS 14, macOS 11, tvOS 14, watchOS 7, *), rawValue == .banner {
                    return "UNNotificationPresentationOptions.banner"
                }
                if #available(iOS 14, macOS 11, tvOS 14, watchOS 7, *), rawValue == .list {
...
extension UNNotificationSetting: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "UNNotificationSetting.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension UNShowPreviewsSetting: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "UNShowPreviewsSetting.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
