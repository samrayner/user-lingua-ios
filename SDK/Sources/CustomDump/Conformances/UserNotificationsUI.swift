...
extension UNNotificationContentExtensionMediaPlayPauseButtonType: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return
                "UNNotificationContentExtensionMediaPlayPauseButtonType.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension UNNotificationContentExtensionResponseOption: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return
                "UNNotificationContentExtensionResponseOption.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
