...
extension GKAccessPoint.Location: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "GKAccessPoint.Location.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
...
extension GKPlayer.PhotoSize: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "GKPlayer.PhotoSize.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
...
extension GKTurnBasedMatch.Outcome: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "GKTurnBasedMatch.Outcome.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension GKTurnBasedMatch.Status: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "GKTurnBasedMatch.Status.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension GKTurnBasedParticipant.Status: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "GKTurnBasedParticipant.Status.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
