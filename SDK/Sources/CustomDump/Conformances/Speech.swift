...
extension SFSpeechRecognizerAuthorizationStatus: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return
                "SFSpeechRecognizerAuthorizationStatus.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension SFSpeechRecognitionTaskHint: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "SFSpeechRecognitionTaskHint.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
...
extension SFSpeechRecognitionTaskState: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        ...
        @unknown default:
            return "SFSpeechRecognitionTaskState.(@unknown default, rawValue: \(rawValue))"
        }
    }
}
#endif
