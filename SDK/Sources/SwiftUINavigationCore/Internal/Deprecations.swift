...
extension AlertState {
    ...
    @available(
        iOS, introduced: 15, deprecated: 100_000,
    ...
    @available(
        tvOS, introduced: 15, deprecated: 100_000,
        message: "Use 'init(title:actions:message:)' instead."
    )
    @available(
        watchOS,
    ...
    @available(
        iOS, introduced: 13, deprecated: 100_000,
        message: "Use 'init(title:actions:message:)' instead."
    )
    @available(
        macOS,
    ...
    @available(
        tvOS, introduced: 13, deprecated: 100_000,
        message: "Use 'init(title:actions:message:)' instead."
    )
    @available(
        watchOS,
...
@available(iOS, introduced: 13, deprecated: 100_000, renamed: "ConfirmationDialogState")
@available(macOS, introduced: 12, unavailable)
@available(tvOS, introduced: 13, deprecated: 100_000, renamed: "ConfirmationDialogState")
@available(watchOS, introduced: 6, deprecated: 100_000, renamed: "ConfirmationDialogState")
