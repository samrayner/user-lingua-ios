...
extension Effect {
    ...
    ///   identifier.
    public static func cancel(id: some Hashable) -> Self {
...
extension Task where Success == Never, Failure == Never {
    ...
    public static func cancel(id: some Hashable) {
        @Dependency(\.navigationIDPath) var navigationIDPath
...
public class CancellablesCollection {
    ...
    func insert(
        ...
        for navigationIDPath in path.prefixes {
            ...
            storage[cancelID, default: []].insert(cancellable)
        }
    }
    ...
    func remove(
        ...
        for navigationIDPath in path.prefixes {
            let cancelID = _CancelID(id: id, navigationIDPath: navigationIDPath)
            storage[cancelID]?.remove(cancellable)
    ...
    func exists(
        ...
        storage[_CancelID(id: id, navigationIDPath: path)] != nil
    }
