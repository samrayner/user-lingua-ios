...
extension View {
    ...
    ///     alert.
    @available(iOS, introduced: 13, deprecated: 100_000, message: "use `View.alert(store:) instead.")
    @available(
        macOS, introduced: 10.15, deprecated: 100_000, message: "use `View.alert(store:) instead."
    )
    @available(tvOS, introduced: 13, deprecated: 100_000, message: "use `View.alert(store:) instead.")
    @available(
        watchOS, introduced: 6, deprecated: 100_000, message: "use `View.alert(store:) instead."
    )
    public func legacyAlert<ButtonAction>(
        ...
        legacyAlert(store: store, state: { $0 }, action: { $0 })
    }
