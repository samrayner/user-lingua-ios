        ...
        NavigationStack(
            path: viewStore.binding(
                ...
                compactSend: { newPath in
                    ...
                    } else if newPath.count < viewStore.path.count {
                        .popFrom(id: viewStore.path[newPath.count].id)
                    } else {
                        nil
                    }
                }
            ...
            root
                ...
                .navigationDestination(for: StackState<State>.Component.self) { component in
                    NavigationDestinationView(component: component, destination: destination)
                }
        }
    }
}
