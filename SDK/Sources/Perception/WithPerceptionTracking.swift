...
extension WithPerceptionTracking: TableColumnContent where Content: TableColumnContent {
    ...
    public init(@TableColumnBuilder<Content.TableRowValue, Content.TableColumnSortComparator> content: @escaping () -> Content) {
        self.content = content
    }

    public nonisolated var tableColumnBody: Never {
        fatalError()
    }
...
extension WithPerceptionTracking: TableRowContent where Content: TableRowContent {
    ...
    public init(@TableRowBuilder<Content.TableRowValue> content: @escaping () -> Content) {
        self.content = content
    }

    public nonisolated var tableRowBody: Never {
        fatalError()
    }
}
