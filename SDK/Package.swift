...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/pointfreeco/swift-composable-architecture", .upToNextMinor(from: "1.10.3")),
        ...
        .package(url: "https://github.com/JosephDuffy/HashableMacro", branch: "main")
    ],
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                .product(name: "HashableMacro", package: "HashableMacro")
            ]
        ),
        .target(
            name: "Theme",
